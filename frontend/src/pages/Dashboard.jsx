...
const Dashboard = () => {
  ...
  if (loading) {
    return (
      <>
        <PageTitle title="Dashboard" description="Track your learning progress on AquaLearn." />
  ...
  return (
    <>
      <PageTitle title="Dashboard" description="Track your aquaculture learning progress on AquaLearn." />
          ...
          <AnimatedSection animation="fade-up">
            <div className="bg-gradient-to-r from-deep-ocean to-clear-teal rounded-brand-lg shadow-card p-6 mb-8 text-white">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <Link
                  to="/courses"
                  className="bg-white text-deep-ocean px-6 py-2 rounded-brand font-medium hover:bg-white/90 transition-all duration-300 hover:scale-105"
                >
                  Browse Courses
                </Link>
              </div>
              ...
              {earned_certificates.length > 0 && (
                <AnimatedSection animation="fade-up" delay={500}>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Link to="/certificates" className="text-sm text-clear-teal hover:underline">
                      View All →
                    </Link>
                  </div>
                  <div className="space-y-3">
                    {earned_certificates.slice(0, 3).map((cert, index) => (
