...
INSTALLED_APPS = [
    ...
    # 'django_ratelimit',  # REMOVED - using custom rate limiter
...
# ============================================================================
# Rate limiting settings for custom rate limiter
RATE_LIMIT = {
    'LOGIN': {
        'max_attempts': 5,
...
# CACHE CONFIGURATION
# ============================================================================
# Simple cache for development - works with custom rate limiter
CACHES = {
    'default': {
